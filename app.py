...
<div class="main-header">
    ...
    <p>Tác giả: Hoàng Thị Mặc - Trường Tiểu học Trung Thành - ĐT: 0944 564 460</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Hoàng Thị Mặc - Trường Tiểu học Trung Thành - ĐT: 0944 564 460</div>", unsafe_allow_html=True)
